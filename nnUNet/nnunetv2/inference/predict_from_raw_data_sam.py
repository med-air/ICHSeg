...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.image_encoder import ImageEncoderViT
import nnunetv2
...
from nnunetv2.inference.sliding_window_prediction import predict_sliding_window_return_logits_sam, compute_gaussian
...
def predict_logits_from_preprocessed_data(data: torch.Tensor,
    ...
    sam = ImageEncoderViT(
        ...
        window_size=14,
        out_chans=256).cuda()
    sam2 = sam_model_registry["vit_b"](
        checkpoint="/home/petergong/Documents/research/3DSAM_adapter/sam_vit_b_01ec64.pth")
    sam.load_state_dict(sam2.image_encoder.state_dict())
    sam.eval()
        ...
        try:
            for params in parameter_list:
                ...
                if prediction is None:
                    prediction = predict_sliding_window_return_logits_sam(
                        network, sam, data, num_seg_heads,
